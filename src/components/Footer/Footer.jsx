            ...
            <div className="row">
              <div className="footer-wrapper">
                ...
                <form className="input-wrapper">
                  <fieldset class="w-full m-0 flex sm:place-content-between flex-row space-x-8">
                    <div class="flex-grow">
                      <label
                        for="language"
                        class="leading-5 font-semibold tracking-wider uppercase text-xxs block mb-1 text-gray-400 px-1"
                      >
                        Language
                      </label>
                      <div class="select-box">
                        ...
                        <div
                          class="pointer-events-none absolute inset-y-0 right-0 flex items-center p-1"
                          aria-hidden="true"
                        >
                          <svg
                            fill="none"
                            ...
                            width="1em"
                            height="1em"
                            class="stroke-current text-white text-base absolute right-0 text-white"
                          >
                            <path
