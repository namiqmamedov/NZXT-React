        ...
        <div className="login-google">
          <button>
            ...
            >
              <path
                fill="#fbc02d"
                d="M44 20H24v8h11a12 12 0 11-3-13l6-6A20 20 0 004 24a20 20 0 1040-4z"
              ></path>
              <path
                fill="#e53935"
                d="M6 15l7 5a12 12 0 0119-5l6-6a20 20 0 00-32 6z"
              ></path>
              <path
                fill="#4caf50"
                d="M24 44c5 0 10-2 13-5l-6-5a12 12 0 01-18-6l-7 5c4 7 10 11 18 11z"
              ></path>
              <path
                fill="#1565c0"
            ...
            <div className="item-check">
              <Checkbox className="checkbox-index" color="secondary">
                <span className="remember-text">
                  I accept the NZXT's <Link>Terms of Use</Link> and have read
