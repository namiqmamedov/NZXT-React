          ...
          <div className="row">
            <div className="product-list-index">
              <div className="col-lg-4">
                ...
                <h1 className="title">THE NEW H9 SERIES</h1>
          ...
          <div className="row">
            <div className="item-index">
              <div className="content-item">
                <div
                  className="content-full col-lg-4 col-12"
                  style={{ backgroundColor: "#F5F5F8" }}
                >
                  <img src={nzxtLogo} alt="NZXT Logo" title="NZXT Logo" />
                  <h3>Better Together</h3>
                  <p>
                    Create the ultimate desk setup with our lineup; whether it
                    is a Canvas Monitor, a Capsule Mic, a Function Keyboard, or
                    any of our other great products, you can combine them to
                    make for a customizable and cohesive desktop environment.
                  </p>
